...
[0] = LAYOUT_preonic_1x2uC(
  ...
  MO(4),        KC_LCTL,    KC_LALT,    KC_LGUI,    MO(2),      KC_SPC,     MO(3),      KC_LCTL,    KC_LEFT,    KC_DOWN,    KC_RGHT
),
...
KC_NO,      KC_LCTL,    KC_LALT,    KC_LGUI,    KC_TRNS,    KC_SPC, MO(5),  KC_NO,      KC_NO,      KC_NO,      KC_NO
),
...
KC_NO, KC_NO, KC_NO, KC_NO, MO(5), KC_NO, KC_TRNS,  KC_P0,  KC_PDOT,    KC_NO,   KC_NO
),
...
KC_NO,      KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_NO, KC_NO, KC_NO, KC_NO,      KC_MRWD,    KC_VOLD,    KC_MFFD
),
