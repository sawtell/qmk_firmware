...
[0] = LAYOUT_preonic_1x2uC(
  ...
  MO(4),            KC_LCTL,    KC_LALT,    KC_LGUI,    MO(3),      KC_SPC,     MO(4),      KC_LEFT,    KC_UP,      KC_DOWN,    KC_RGHT
),
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Shift |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  Fn  | Alt  | Cmd  |Space |    Space    |Adjust| Left |  Up  | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
...
KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
KC_LCTL, MO(4),   KC_TRNS, KC_TRNS, KC_SPC,  KC_TRNS, MO(5),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
),
...
KC_NO,      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,      KC_NO,      KC_NO,      KC_LPRN,    KC_RPRN,    KC_DEL,
KC_NO,      KC_F7,      KC_F8,      KC_F9,      KC_F10,     KC_F11,     KC_F12,     KC_MINS,    KC_EQL,     KC_LBRC,    KC_RBRC,    KC_NO,
KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_UNDS,    KC_DLR,     KC_LCBR,    KC_RCBR,    KC_NO,
KC_LSFT,    KC_GRV,     KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_PIPE,    KC_LT,      KC_GT,      KC_SLSH,    KC_NO,
KC_NO,      KC_LCTL,    KC_LALT,    KC_LGUI,    KC_TRNS,    KC_SPC,     KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS
),
...
KC_NO, KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS, MO(5),    KC_P0,  KC_PDOT,    KC_NO,   KC_NO
),
...
* |------+------+------+------+------+-------------+------+------+------+------+------|
* |      | Play | Prev | Next | Mute |VolUp |VolDwn| Left | Down |Right |PgDown|      |
* |------+------+------+------+------+------|------+------+------+------+------+------|
* | Shift|      |      |      |      |      |      |      |      |      |      |      |
* |------+------+------+------+------+------+------+------+------+------+------+------|
* |      |      |      |      |Adjust|    Space    |  VVV |      |      |      |      |
